...
const rows = [
    ...
    { id: 2, prenom: 'Falilou', nom: 'Fall' },
    { id: 3, prenom: 'Mamadou', nom: 'Sow' },
    { id: 4, prenom: 'Mame Diarra', nom: 'Sow' },
    { id: 5, prenom: 'Ibrahima Birane', nom: 'Faye' },
    { id: 6, prenom: 'Kalidou', nom: 'Dia' },
    { id: 7, prenom: 'Fallou', nom: 'Diakhaté' },
    { id: 8, prenom: 'Khadim', nom: 'Diakhaté' },
    { id: 9, prenom: 'Sokhna Cambel', nom: 'Dieng' },
];
...
export default function ListeAbsents(props) {
