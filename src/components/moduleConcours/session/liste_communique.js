...
import logo from '../../../assets/moduleConcours/img/green.jpg';
import {connect} from "react-redux";
import {get_SessionsAll} from "../../../actions/moduleConcours/action_session"; // with import

function Liste_Communique(props) {
    ...
    if (checkIf){
        sessions.map(session => {
            rapports.push({ name: `Communiqués Session ${session.annee_session}`, id: 'id-dossier', annee: session.annee_session })
        })
                ...
                <div className="product-item-content">
                    ...
                    <div>
                        ...
                        <div className="car-buttons p-mt-5">
                            <Link to={"/scolarite/concours/communiques/" + rapport.annee}>
...
export default connect(mapStateToProps,{get_SessionsAll})(Liste_Communique)