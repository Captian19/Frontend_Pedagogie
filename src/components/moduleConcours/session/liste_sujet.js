...
import logo from '../../../assets/moduleConcours/img/red.png';
import {connect} from "react-redux"; // with import

function Liste_Sujet(props) {
    ...
    if (checkIf){
        sessions.map(session => {
            rapports.push({ name: `Sujets Session ${session.annee_session}`, id: 'id-dossier', annee: session.annee_session })
        })
                ...
                <div className="product-item-content">
                    ...
                    <div>
                        ...
                        <div className="car-buttons p-mt-5">
                            <Link to={"/scolarite/concours/sujets/" + rapport.annee}>
...
export default connect(mapStateToProps,{get_SessionsAll})(Liste_Sujet)