...
class FormulaireInscriptionAncien extends Component {
     
    state = { 
        IDE:this.props.user.id,
        nom:this.props.user.last_name, 
        prenom:this.props.user.first_name,
        email:this.props.user.email, 
        classe:this.props.user.CurrentRoles[0].classe, 
        departement:this.props.user.CurrentRoles[0].departement, 
        anneeScolaire:`${this.props.user.CurrentRoles[0].date_debut.split("-")[0]}-${this.props.user.CurrentRoles[0].date_fin.split("-")[0]}`,
        dateNaissance : '',
        lieuNaissance : '',
        numeroCarteEtudiant : '',
        paysOrigine : '',
        ...
        anneeDernierEtablissementFreq : '2020',
...
export default withRouter(FormulaireInscriptionAncien)