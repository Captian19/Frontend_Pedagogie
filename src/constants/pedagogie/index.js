export const API_URL_UE1 =  "http://localhost:8000/UE/departement";
export const API_URL_EC =  "http://localhost:8000/EC";
export const API_URL_Support_cours =  "http://localhost:8000/Support_cours";
