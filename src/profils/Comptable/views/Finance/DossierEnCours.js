...
class DossierEncours extends React.Component{
    constructor(props) {
        super(props);
        this.state = {liste:[]};
    }
    ...
    componentDidMount(){
        fetch("http://localhost:8000/mandatement/MandatAcComptCours/")
            .then(res => res.json())
                                        ...
                                        <div className="backside">
                                            <div className="card" style={{marginBottom:"0px"}}>
                                                <div className="card-body text-center mt-4">
                                                    ...
                                                    {i.valid_comptable && <div class="d-flex justify-content-center card-title"><img src={coche} alt="coche" width="45px" height="45px"/></div>}
                                                    ...
                                                    <button
                                                       ...
                                                       <Link to={`mandatviewac/${i.id_Ac}`}>voir plus</Link> </button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
export default connect(mapStateToProps,null)(DossierEncours);