...
class InitButtonAC extends React.Component{
      ...
      componentDidMount(){
       ...
       handleSubmitAc=()=>{
        ...
        const dataToSend = {avis_credit:this.state.liste.avis_credit, avis_creditUpload:this.state.liste.avis_creditUpload,
            ...
            rejet_comptable:false, rejet_directeur:this.state.liste.rejet_directeur, 
            valid_comptable:true, valid_directeur:this.state.liste.valid_directeur}
    ...
    render() {
        return(
            <>
                <button type="button" ref="btn" className='btn btn-lg btn-success' onClick={this.handleSubmitAc}>
