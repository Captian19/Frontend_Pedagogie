...
import ProfilComptable from "../../../components/moduleInscription/ProfilComptable";
...
class Liste extends Component {
    ...
    renderEtudiant = etudiant => {
      ...
      return (
        <ProfilComptable etudiant = {etudiant} liste={true}></ProfilComptable>
      );
    };
                              ...
                              return (
                                      ...
                                      <tr>
                                        ...
                                        <td className="justify-content-end">
                                          <Link to={`/comptable/dossier-etudiant-fichiers/${etudiant.email}`}
