...
class AnnulerValidationBC extends React.Component{
    constructor(props) {
        super(props);
        this.state =  { 
            liste:[]   
    ...
    render() {
        return(
            <>
                <button type="button" ref="btn" className='btn btn-lg btn-warning' onClick={this.handleSubmitBc}>
...
export default AnnulerValidationBC;