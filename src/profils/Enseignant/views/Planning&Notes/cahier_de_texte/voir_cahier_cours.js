            ...
            {loading ?
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <Typography variant="body2" color="textSecondary" component="p">Pourcentage d'exécution : {progression.nbHeuresExecutees * 100 / cours.chargeHoraire} %</Typography>
                    </CardContent>
                        ...
                        <CardContent>
                            {seances.map(
                                (seance, index) => {
                                    ...
                                    return (
                                        <Paper key={index} style={{ backgroundColor: "#2699FB" }}>
