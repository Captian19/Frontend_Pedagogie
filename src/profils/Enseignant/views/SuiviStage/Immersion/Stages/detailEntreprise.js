  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        <Grid container spacing={2}>
          <Grid item>
            <ButtonBase className={classes.image}>
              <img className={classes.img} alt="img" src="https://www.cm-gap.fr/wp-content/uploads/2019/10/maintenance-informatique.jpg" />
            </ButtonBase>
          </Grid>
          <Grid item xs={12} sm container>
            ...
            <Grid item >
                <Typography variant="subtitle1" color="textPrimary">
                  {props.actif ? 
                  <button className="btn btn-danger" onClick={props.desactiver}>Désactiver</button> 
                  : <button className="btn btn-success" onClick={props.desactiver}>Activer</button> 
        ...
        <Grid item md={12}>
                <Typography variant="subtitle1" color="textPrimary">
                  <Link to={{pathname:`/enseignant/immersion/single/${props.slug}/postulants`} }>
...
function Stage(props){
    ...
    return (
        ...
        <CCol xs="12" sm="6" md="4">
          <Link style={{textDecoration:'none', color:'grey'}} to={{pathname:`/enseignant/immersion/single/${props.slug}/stage/edit/${props.numero}`} }>
            <CCard>
            <CCardHeader>
