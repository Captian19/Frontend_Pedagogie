...
class AvisCreditUpload extends Component {
    constructor(props) {
        super(props);
        this.state = {
            document : [],
    ...
    saveDocumentsEtudiant = (event) => {
        ...
        fetch(`http://127.0.0.1:8000/mandatement/uploadAvisCredit/${this.state.liste[4]}/`, {
            method: 'PUT',
            headers: {
                                ...
                                <div id="file-upload-form" class="uploader mt-5">
                                    ...
                                    <label for="file-upload" id="file-drag">
                                        <div id="start">
                                            ...
                                            <div><b>Avis Credit Upload</b></div>
                                            {this.fileData()}
...
export default AvisCreditUpload;