...
class BordereauUpload extends Component {
    constructor(props) {
        super(props);
        this.state = {
            document : [],
    ...
    saveDocumentsEtudiant = (event) => {
        ...
        fetch(`http://127.0.0.1:8000/mandatement/uploadBordereauAc/${this.state.liste[4]}/`, {
            method: 'PUT',
            headers: {
...
export default BordereauUpload;