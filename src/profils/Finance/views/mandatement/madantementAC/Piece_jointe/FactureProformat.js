...
class FactureProformat extends Component {
    ...
    async componentDidMount(){
        ...
        await delay(500);
        const dataToSend = {facture_proformat:this.state.liste[5], bon_d_engagement:this.state.liste[7],bon_d_engagementUpload:this.state.liste[12],bl:this.state.liste[3],facture_definitive:this.state.liste[4],pv:this.state.liste[2], pv_upload:this.state.liste[8], mandat:this.state.liste[0], mandatUpload:this.state.liste[9],avis_credit:this.state.liste[1],avis_creditUpload:this.state.liste[10],bordereau_trans:this.state.liste[6],bordereau_transUpload:this.state.liste[11], editeur:this.props.user.first_name +" "+ this.props.user.last_name}
        ...
        await delay(600);
        fetch(`http://127.0.0.1:8000/mandatement/MandatementAc/${this.state.liste[5]}/`)
        .then(res => res.json())
    ...
    handleSubmit= (event) => {
        ...
        const dataToSend1 =  {facture_proformat:this.state.lot.facture_proformat, bon_d_engagement:this.state.lot.bon_d_engagement,
            ...
            avis_credit:this.state.lot.avis_credit, avis_creditUpload:this.state.lot.avis_creditUpload, bordereau_trans:this.state.lot.bordereau_trans,
            ...
            fetch(`http://127.0.0.1:8000/mandatement/MandatementAc/${this.state.liste[2]}/`,{
            method: 'PUT',
            headers: {
              Accept: 'application/json', 'Content-Type': 'application/json'},
...
export default connect(mapStateToProps,null)(FactureProformat);