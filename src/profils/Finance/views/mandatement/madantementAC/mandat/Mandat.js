                ...
                <thead className="alice">
                    ...
                    <tr class="centre">
                        ...
                        <tr class="centre">
                            ...
                            <th scope="col" style={{border:"1px solid #dee2e6"}} class=" align-top" rowspan="2" ><span class="spanner"> <input type="text" required class="input-group-text abcd" name="anneeOrigine" autoComplete="off" disabled onChange={this.handleChangeAnneeOrigine} value={this.state.anneeOrigine=this.state.liste[13]} type="number"/> </span></th>
