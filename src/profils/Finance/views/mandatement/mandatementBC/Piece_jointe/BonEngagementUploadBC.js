...
class BonEngagementUploadBC extends Component {
    constructor(props) {
        super(props);
        this.state = {
            document : null,
    ...
    saveDocumentsEtudiant = (event) => {
        ...
        fetch(`http://127.0.0.1:8000/mandatement/uploadBonEngagementBc/${this.state.liste[12]}/`, {
            method: 'PUT',
            headers: {
...
export default BonEngagementUploadBC;