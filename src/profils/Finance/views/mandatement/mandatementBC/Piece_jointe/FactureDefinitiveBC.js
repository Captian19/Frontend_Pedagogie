...
class FactureDefinitiveBC extends Component {
    constructor(props) {
        super(props);
        this.state = {
            document : null,
    ...
    saveDocumentsEtudiant = (event) => {
        ...
        fetch(`http://127.0.0.1:8000/mandatement/uploadFDBc/${this.state.liste[4]}/`, {
            method: 'PUT',
            headers: {
                                ...
                                <div id="file-upload-form" class="uploader mt-5">
                                    ...
                                    <label for="file-upload" id="file-drag">
                                        <div id="start">
                                            ...
                                            <div><b>Facture Definitive</b></div>
                                            {this.fileData()}
...
export default FactureDefinitiveBC;