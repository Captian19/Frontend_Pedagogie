                    ...
                    <table className="table table-bordered text-center shadow p-3 mb-5 bg-white rounded largeur"
                        ...
                        <thead  id="page">
                            ...
                            <tr className="centre" style={{height:'300px',border: "1px solid #0F1019"}}>
                                <th scope="col" style={{border: "1px solid #0F1019", fontWeight: "bold", fontSize:"1.1em"}} rowSpan="4"
                                    ...
                                    style={{border: "none", LineWeight: "20px;", fontSize:"1.1em"}} required></textarea></span></th>
