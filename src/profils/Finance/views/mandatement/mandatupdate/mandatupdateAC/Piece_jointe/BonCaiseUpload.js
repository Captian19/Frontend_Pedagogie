...
class BonCaiseUpload extends Component {
    constructor(props) {
        super(props);
        this.state = {
            document : null,
    ...
    saveDocumentsEtudiant = (event) => {
        ...
        fetch(`http://127.0.0.1:8000/mandatement/uploadBonDeCaisse/${this.props.id_Ac}/`, {
            method: 'PUT',
            headers: {
