...
class BonEngagementUpload extends Component {
    constructor(props) {
        super(props);
        this.state = {
            document : [],
    ...
    saveDocumentsEtudiant = (event) => {
        ...
        fetch(`http://127.0.0.1:8000/mandatement/uploadBonEngagementAc/${this.props.id_Ac}/`, {
            method: 'PUT',
            headers: {
                                ...
                                <div id="file-upload-form" class="uploader mt-5">
                                    ...
                                    <label for="file-upload" id="file-drag">
                                        <div id="start">
                                            ...
                                            <div><b>Bon Engagement Upload</b></div>
                                            {this.fileData()}
...
export default BonEngagementUpload;