...
function getStepContent(step,id) {
    switch (step) {
        case 0:
            return <Engagement id_Ac ={id}/>;
        case 1:
            return <Liquidation id_Ac ={id} />;
        case 2:
            return <Ordonnancement id_Ac ={id} />;
        default:
            return 'Unknown step';
    }
}

export default function MandatupdateAC(props) {
                                ...
                                <div className={classes.root}>
                                    ...
                                    <div>
                                        {activeStep === steps.length ? (
                                            ...
                                            <div>
                                                <Typography className={classes.instructions}>{getStepContent(activeStep,props.match.params.id_Ac)}</Typography>
                                                <div>
