...
class BonCaisseAjout extends React.Component {
    constructor(props) {
        super(props);
      ...
      handleSubmit=(event)=> {
        ...
        const dataToSend = {exercice: this.state.exercice, gestion: this.state.gestion, sommeMandate:this.state.sommeMandate, nomCreancier:this.state.nomCreancier, sommeNette:this.state.sommeNette, anneeOrigine:this.state.anneeOrigine, date:this.state.date, nBordereau:this.state.nBordereau, nMandat:this.state.nMandat, imputation:this.state.imputation, justification:this.state.justification, id_mandat:this.props.id_Bc}
            ...
            <div>
                <table class="table table-bordered text-center shadow-lg p-3 mb-5 bg-white rounded largeur" style={{width:"1100px",fontSize:"1em"}}>
                    ...
                    <tr class="centre">
                        ...
                        <th scope="col" class=" align-top" rowspan="2" style={{border:"1px solid #dee2e6",fontWeight:"bold"}}><span class="spanner"> <input class="input-group-text abc" type="number" disabled onChange={this.handleChangeNBordereau} value={this.state.nBordereau=this.props.id_Bc}/> </span></th>
                        <th scope="col" class=" align-top" rowspan="2" style={{border:"1px solid #dee2e6",fontWeight:"bold"}}><span class="spanner"> <input class="input-group-text abc" type="number" disabled onChange={this.handleChangeNMandat} value={this.state.nMandat=this.props.id_Bc}/> </span></th>
