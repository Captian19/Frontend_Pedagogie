...
class MandatUploadBC extends Component {
    constructor(props) {
        super(props);
        this.state = {
            document : [],
    ...
    saveDocumentsEtudiant = (event) => {
        ...
        fetch(`http://127.0.0.1:8000/mandatement/uploadMandatBc/${this.props.id_Bc}/`, {
            method: 'PUT',
            headers: {
