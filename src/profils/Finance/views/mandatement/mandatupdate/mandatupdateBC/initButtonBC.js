...
class InitButtonBC extends React.Component{
    constructor(props) {
      ...
      handleSubmitBc=()=>{
        ...
        fetch('http://127.0.0.1:8000/mandatement/BordereauBc/',{
        method: 'POST',
        headers: {
        ...
        fetch('http://127.0.0.1:8000/mandatement/BonEngagementBc/',{
          method: 'POST',
            headers: {
              Accept: 'application/json', 'Content-Type': 'application/json'},
        ...
        fetch('http://127.0.0.1:8000/mandatement/mandatBc/',{
        method: 'POST',
        headers: {
            Accept: 'application/json', 'Content-Type': 'application/json'},
        ...
        fetch('http://127.0.0.1:8000/mandatement/pvBc/',{
            method: 'POST',
            headers: {
                Accept: 'application/json', 'Content-Type': 'application/json'},
        ...
        fetch('http://127.0.0.1:8000/mandatement/uploadFPBc/',{
          method: 'POST',
          body: formData
        }).then(
            data => console.log(data)
        ...
        fetch('http://127.0.0.1:8000/mandatement/uploadFDBc/',{
          method: 'POST',
          body: formData
        }).then(
            data => console.log(data)
        ...
        fetch('http://127.0.0.1:8000/mandatement/uploadBLBc/',{
          method: 'POST',
          body: formData
        }).then(
            data => console.log(data)
        ...
        fetch('http://127.0.0.1:8000/mandatement/uploadMandatBc/',{
          method: 'POST',
          body: formData
        }).then(
            data => console.log(data)
        ...
        fetch('http://127.0.0.1:8000/mandatement/uploadBonDeCaisse/',{
          method: 'POST',
          body: formData
        }).then(
            data => console.log(data)
        ...
        fetch('http://127.0.0.1:8000/mandatement/uploadBordereauBc/',{
          method: 'POST',
          body: formData
        }).then(
            data => console.log(data)
        ...
        fetch('http://127.0.0.1:8000/mandatement/uploadBonEngagementBc/',{
            method: 'POST',
            body: formData
          }).then(
              data => console.log(data)
          ...
          fetch('http://127.0.0.1:8000/mandatement/uploadPvReceptionBc/',{
            method: 'POST',
            body: formData
          }).then(
              data => console.log(data)
    ...
    render() {
        return(
            <>
                <button type="button"  className='btn btn-lg btn-success' onClick={this.handleSubmitBc}>
                    <CreateNewFolderIcon/><Link to='mandatementbc'>Mandatement Bon de caisse</Link>
                </button>
            </>
        )
    }
