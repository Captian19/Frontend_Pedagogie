...
import BonCaisseAjout from "./BonCaisseAjout/BonCaisse";
import ReactToPrint from "react-to-print";
import MandatBC from "./mandatBC/MandatBC";
import "./mandatBC/print.css";
...
function getSteps() {
    return ['Mandat','Ajouter Bon de Caisse', 'Update Bon de Caisse', 'Bordereau'];
}
    ...
    switch (step) {
        case 0:
            return (
                <>
                    <div>
                        <MandatBC id_Bc={id} ref={componentRef} />
                        <ReactToPrint
                            trigger={() => <Button className="btn btn-outline-primary">Imprimer</Button>}
                            content={() => componentRef.current}
                        />
                    </div>
                    <MandatUploadBC id_Bc={id}/>
                </>
            )
        case 1:
            return (
                <>
                    <BonCaisseAjout id_Bc={id}/>
                </>
            )
        case 2:
            return (
                <>
                    <div>
                        <BonCaisse id_Bc={id}  ref={componentRef} />
                        <ReactToPrint
                            trigger={() => <Button className="btn btn-outline-primary">Imprimer</Button>}
                            content={() => componentRef.current}
                        />
        ...
        case 3:
            return (
                <>
                    <BordereauBC id_Bc={id}/>
                    <BordereauUploadBC id_Bc={id}/>
                </>
            )
        default:
            return 'Unknown step';
...
export default function OrdonnancementBC(props) {
