...
import Search from "./VisiteMedicale";
                            ...
                            {this.state.etudiants.map(etudiant => {
                              return (
                                      ...
                                      <tr>
                                        ...
                                        <td className="justify-content-end"><Link to={`/medecin/consultation/${etudiant.id}`} className="btn btn-primary">Consulter</Link></td>
                                      </tr>
                              )
                            } )}
                          </tbody>
