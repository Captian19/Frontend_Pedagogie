...
class ListeDossier extends Component {
                              ...
                              return (
                                      ...
                                      <tr>
                                        ...
                                        <td className="justify-content-end">
                                          <Link to={`/scolarite/dossier/
                                          ${etudiant.user.first_name}/${etudiant.user.last_name}/${etudiant.user.email}/${etudiant.classe}/${etudiant.departement}/${etudiant.annee.split("/")[0]}/${etudiant.annee.split("/")[1]}/${etudiant.user.id}`}
                                           className="btn btn-primary">Consuter dossier
                                           </Link>
                                        </td>
                                      </tr>
                              )
